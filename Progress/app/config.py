...
# 系统配置
DEFAULT_MUSIC_PATH = r"F:\程序员的日常\python\AI_Manager\Progress\resoures\Music"  # 默认音乐路径
DEFAULT_DOCUMENT_PATH = r"F:\程序员的日常\python\AI_Manager\Progress\resoures\Documents"  # 默认文档路径
